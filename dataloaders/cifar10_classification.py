...
class Cifar10Classification(Dataset):
    ...
    def __init__(
        ...
        self.cifar10 = torchvision.datasets.CIFAR10(root=self.data_path, train=False if self.data_mode == "test" else True,
                                                    download=self.data_download, transform=None)
